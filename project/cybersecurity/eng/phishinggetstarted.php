...
<body>
  ...
  <a class="active" href="phishinggetstarted.php">DETECTING PHISHING</a>
    ...
    <div  style=" padding-top: 0.5%; padding-bottom:10%; min-height:80%;">
        ...
        <img src="Image\banner_phishing.jpg" style="width: 100%; float: center; margin-top:0.5%" onContextMenu="return false;"></img>
        ...
        <div class="containerwordwall"> 
            <video class="responsive-iframewordwall" src="Image\video 01.mp4" autoplay loop frameborder="0" allowfullscreen onContextMenu="return false;"></video>
        </div>

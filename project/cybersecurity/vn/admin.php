  ...
  <div class="header-right">
    ...
    <div style="background-color: rgb(219, 226, 245); padding-top: 3%; padding-bottom:10%">
      <div>
        ...
        $sql_count_login = "SELECT SUM(login_count) FROM user";
        ...
        ?> 
         <?php
                if(isset($_POST['buttonstart_phishing'])) { 
                    $sql = " UPDATE user SET phishinggamestatus = 1 ";
                    mysqli_query($conn,$sql);
                    ?>
                      <script type="text/javascript">
                      window.location.href = 'admin.php';
                ...
                if(isset($_POST['buttonstop_phishing'])) { 
                    $sql = " UPDATE user SET phishinggamestatus = 0 WHERE role='user'";
                    mysqli_query($conn,$sql);
                    ?>
                      <script type="text/javascript">
                      window.location.href = 'admin.php';
        ...
        ?> 
         <?php
                if(isset($_POST['buttonstart_cyberattack'])) { 
                    $sql = " UPDATE user SET cyberattackstatus = 1";
                    mysqli_query($conn,$sql);
                    ?>
                      <script type="text/javascript">
                      window.location.href = 'admin.php';
                ...
                if(isset($_POST['buttonstop_cyberattack'])) { 
                    $sql = " UPDATE user SET cyberattackstatus = 0 WHERE role='user'";
                    mysqli_query($conn,$sql);
                    ?>
                      <script type="text/javascript">
                      window.location.href = 'admin.php';
        ...
        ?> 
         <?php
                if(isset($_POST['buttonstart'])) { 
                    $sql = " UPDATE user SET passwordgamestatus = 1";
                    mysqli_query($conn,$sql);
                    ?>
                      <script type="text/javascript">
                      window.location.href = 'admin.php';
                ...
                if(isset($_POST['buttonstop'])) { 
                    $sql = " UPDATE user SET passwordgamestatus = 0 WHERE role='user'";
                    mysqli_query($conn,$sql);
                    ?>
                      <script type="text/javascript">
                      window.location.href = 'admin.php';

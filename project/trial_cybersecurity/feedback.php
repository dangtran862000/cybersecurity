...
<div class="container" style="margin-top: 5%">
  <form action="feedbackinput.php" method="get">
  <div class="row">
    <div class="col-25">
      <label for="fname" style="padding-left: 30px; font-size:20px">Tên của bạn</label>
    </div>
    <div class="col-75">
      <input type="text" id="fname" name="name" placeholder="Tên của bạn.." style="margin-top: 0.5%;">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="lname" style="padding-left: 30px; font-size:20px">Email của bạn</label>
    </div>
    <div class="col-75">
      <input type="text" id="lname" name="email" placeholder="Email của bạn.." style="margin-top: 1%;">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="outcome" style="padding-left: 30px; font-size:20px">Sau buổi workshop bạn thấy: </label>
    </div>
    <div class="col-75">
      <select id="outcome" name="outcome" style="margin-top: 2%;">
  ...
  <div class="row">
    <div class="col-25">
      <label for="comment" style="padding-left: 30px; font-size:20px">Ý kiến của bạn</label>
    </div>
    <div class="col-75">
  ...
  <br>
  <div class="row">
    <input type="submit" value="Gửi phản hồi của bạn">
  </div>
  </form>
</div>
